...
class FeatureContext extends RawDrupalContext implements SnippetAcceptingContext {
  ...
  /**
   * Closes driver to prevent errors because of open dialogs.
   *
   * @AfterScenario
   */
...
JS;
  ...
  /**
   * @Given I click the :arg1 element accepting dialog
   */
  public function iClickTheElementAcceptingDialog($selector) {
  ...
  /**
   * Reloads current page accepting confirm dialog
   *
   * Example: When I reload the page accepting dialog
   * Example: And I reload the page accepting dialog
   *
   * @When /^(?:|I )reload the page accepting dialog$/
   */
  public function reloadAcceptingDialog() {
